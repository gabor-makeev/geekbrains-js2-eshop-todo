<template>
  <div class="todo-element" :id=element.id v-bind:class="{ 'todo-element-selected': element.selectionState }">
    ...
    <svg v-else-if="element.pinState" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="unlink" class="svg-inline--fa fa-unlink fa-w-16 todo-element-pin" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" @click="$emit('toggle-pin-state', element)">
